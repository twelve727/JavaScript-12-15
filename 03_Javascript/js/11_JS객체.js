...
document.getElementById("btn1").addEventListener("click", function() {
    ...
    //  ** ★★★★★★ 중요 ★★★★★★ **
    // JS에서 key는 무조건 String(묵시적=안써도됨)
    // key 작성 시, "",'',안쓰던 모두 String 인식

const brand = "투썸플레이스";

// this면 현재 객체의 브랜드들이 나옴,,,
const product = {
    'pName' : "텀블러",
    "brand" : "스타벅스",
    ...
    'information' : function() { // 객체의 기능
        ...
        // 해당 객체의 변수가 아닌
        // 전역 변수가 선택됨
        // 왜?? 같은 객체의 변수(key)를 선택하는 법이 별도로 존재
...
document.getElementById("btn2").addEventListener("click", function() {
    ...
    stdList.push( new Student(2, 7, '최정동') );
...
function Student(grade, ban, name) {
    ...
    // 기능
    // 함수를 this.introduce라는 새로 만들 애한테 담아준다.
...
// 이어짐 @@@@@@@@@@@@
    ...
    console.log(JSON.stringify(std)); // 객체 -> json 변환 스트링파이 사용 ★
