...
document.getElementById("check1").addEventListener("click",function() {
    ...
    // script와 일치하는 문자열이 있는지 검사하는 정규표현식 객체


    // 정규표현식 객체 생성 2)
    const regEx = /java/;
    // java와 일치하는 문자열이 있는지 검사하는 정규표현식 객체

    const str1 = "Javascript 공부를 하고 있습니다."
    ...
    console.log("regEx1.test(str3) : " + regEx3.test(str3));
    console.log("regEx1.test(str3) : " + regEx3.exec(str3));
...
document.getElementById("inputName").addEventListener("keyup",function() {
    ...
    // 요소.classList : 요소가 갖고 있는 클래스를 배열로 반환
